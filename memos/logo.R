...
text(0.01, .48, "Declare", pos = 4, cex = 5, col = rgb(51/255,153/255,255/255), family = "Helvetica Neue Medium")
text(0.6, .48, "Design", pos = 4, cex = 5, col = rgb(51/255,153/255,255/255), family = "Helvetica Neue Thin")
#top
