...
#top
points(.965,.69, cex = 3.2, col = rgb(51/255,153/255,255/255), lwd = 4)
points(.965,.69, cex = 1.5, col = rgb(51/255,153/255,255/255), lwd = 4, pch = 16)

#bottom 
points(.965,.41, cex = 3.2, col = rgb(51/255,153/255,255/255), lwd = 4)
points(.965,.41, cex = 3.2, col = rgb(51/255,153/255,255/255), lwd = 4, pch = 16)
points(.965,.41, cex = 2, col = "white", lwd = 4, pch = 16)
dev.off()
