...
test_that("test simple experiment analysis and diagnosis", {
  ...
  potential_outcomes <- declare_potential_outcomes(potential_outcomes_function = proportion_potential_outcomes_function, outcome_variable_name = "Y",
                                                   options = list(population_proportions = .5),
