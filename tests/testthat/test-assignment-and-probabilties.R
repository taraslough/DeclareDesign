...
test_that("test assignment and probability functions", {
  ...
  prob_obs_1 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z1", assignment = assignment_1) 
  prob_obs_2 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z2", assignment = assignment_2) 
  prob_obs_3 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z3", assignment = assignment_3) 
  prob_obs_4 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z4", assignment = assignment_4) 
  prob_obs_5 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z5", assignment = assignment_5) 
  prob_obs_6 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z6", assignment = assignment_6) 
  prob_obs_7 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z7", assignment = assignment_7) 
  prob_obs_8 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z8", assignment = assignment_8) 
  
  prob_obs_9 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z9", assignment = assignment_9) 
  prob_obs_10 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z10", assignment = assignment_10) 
  prob_obs_11 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z11", assignment = assignment_11) 
  
  prob_obs_12 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z12", assignment = assignment_12) 
  prob_obs_13 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z13", assignment = assignment_13) 
  prob_obs_14 <- get_observed_assignment_probabilities(data = smp_draw, treatment_assignment = "Z14", assignment = assignment_14) 
})
