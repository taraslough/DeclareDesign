...
supplying the `sample` object to `make_data()`, or by calling the 
...
sample_1 <- declare_sample(
  declare_variable(),
  N = N
)
make_data(sample = sample_1)
sample_1$make_sample()
# Multinomial, binomial and normal covariates
sample_2 <- declare_sample(
...
make_data(sample = sample_5)

# Here we generate wide-format temporal data 
sample_6 <- declare_sample(
  firm = list(
...
(linear_PO_1 <- make_data(potential_outcomes = outcomes_1,sample = simple_frame))
...
# Make data
make_data(potential_outcomes = probit_PO,sample = simple_frame)
...
# Make data
make_data(potential_outcomes = pois_PO,sample = simple_frame)
...
make_data(potential_outcomes = proportion_PO_2,sample = voter_sample)
...
make_data(potential_outcomes = outcomes_2,sample = sample_7)
...
# Make both datasets
data_1 <- make_data(potential_outcomes = cluster_PO_1,sample = cluster_frame)
data_2 <- make_data(potential_outcomes = cluster_PO_2,sample = cluster_frame)
...
make_data(potential_outcomes = health_outcomes_1,sample = sample_5)
...
make_data(potential_outcomes = health_outcomes_2,sample = sample_5)
