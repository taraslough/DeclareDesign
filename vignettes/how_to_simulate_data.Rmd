...
sample_1 <- declare_population(
  declare_variable(),
  N = N
)
draw_population(population = sample_1)

# Multinomial, binomial and normal covariates
sample_2 <- declare_population(
...
draw_population(population = sample_2)
```
...
draw_population(population = sample_3)
...
draw_population(population = sample_6)
...
draw_population(population = sample_8)
