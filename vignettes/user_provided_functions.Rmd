...
```{r}
poisson_regression_custom <- function(data){
  lm(Y ~ Z, family = "poisson", data = data)
}

analysis      <- declare_analysis(formula = Y ~ Z, treatment_variable = "Z", estimator = poisson_regression_custom, quantity_of_interest = average_treatment_effect )
```
